# Understading the Dementia–Depression Comorbidity
# [Peripheral Level]
...
│   ├── MungeSumstats_MR_data preprocessing.R            ← Quality control (the data preprocessing) for MR data
│   ├── Main analysis.R                                  ← Main analysis (UVMR + MVMR + Mediation)
│   ├── Install_All_Packages.R                           ← Automated package installation
│   ├── Demo_Test_Analysis.R                             ← Quick test
