...
│
├── ⚙️ Configuration
│   └── sample_overlap_config.csv      ← MRlap config (auto-detect by default)
│
├── 📚 Documentation
│   ├── README.md                      ← This file
...
│   ├── [Exposure Data Directories]/   ← Your GWAS data
│   ├── [Mediator Data Directory]/     ← Your mediator GWAS
│   ├── Outcomes/                      ← Outcome GWAS
